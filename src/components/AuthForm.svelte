	...
	<div class="p-6 space-y-4 md:space-y-6 sm:p-8">
		{#if !login}
			<form class="flex flex-col space-y-6" action="/">
				...
				<FloatingLabelInput required type="email" name="email" id="email" bind:value={email}
				...
				<button class="btn btn-primary dark:text-white" on:click={handleSignUp}>Sign up</button>
